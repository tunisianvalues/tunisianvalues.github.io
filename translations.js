window.TV = (function () {
  ...
  const t = {
    fr: {
      ...
      hero_description:
        "Découvrez vos orientations politiques à travers un questionnaire adapté au contexte tunisien.",
      cta_start: "FAIRE LE TEST",
      card_what_title: "QU'EST-CE QUE TUNISIAN VALUES ?",
      card_what_meta:
        "73 questions (+ 25 optionnelles) • 7 axes politiques • ~10 minutes",
      card_what_body:
        'TunisianValues est un quiz politique adapté au contexte tunisien. Vous répondrez à 73 affirmations principales (+ 25 contextuelles optionnelles) selon votre niveau d\'accord, de "Tout à fait d\'accord" à "Pas du tout d\'accord."',
      card_axes_title: "7 AXES POLITIQUES",
      card_axes_meta: "Une analyse multidimensionnelle de vos valeurs",
      card_axes_body:
        "À la fin, vos réponses vous placeront sur 7 grands axes reflétant les différentes sensibilités politiques présentes en Tunisie : Panarabisme, Coopération internationale, Économie, Religion, Société, Démocratie et Gouvernance.",
      section_axes_title: "LES 7 AXES ANALYSÉS",
      section_axes_sub:
        "Votre position sur les grands enjeux de la politique tunisienne",
      footer_copy: "© 2026 TunisianValues.",

      instructions_title: "INSTRUCTIONS",
      instructions_body:
        "On vous présentera une série d'énoncés. Pour chacun, choisissez l'option qui correspond le mieux à votre opinion.",
      btn_start: "COMMENCER",
      ...
      opt_context_mode:
        "Activer les notes d'aide contextuelle (histoire politique et institutions)",

      // --- TRADUCTIONS DE L'INTERMISSION ---
      quiz_intermission_title: "PARTIE PRINCIPALE TERMINÉE !",
      quiz_intermission_text:
        "Vous avez répondu à toutes les questions de base. Vous pouvez dès à présent voir vos résultats, ou continuer avec quelques questions contextuelles (optionnelles) sur des sujets spécifiques (Palestine, environnement, héritage historique...) pour affiner votre profil.",
      ...
      results_uncertain_body:
        'Vous avez répondu "Neutre" à une majorité de questions (>50%). Vous êtes probablement Indépendant.',
      ...
      results_refine_body:
        "Attribuez une importance à chaque axe pour ajuster le calcul.",
      btn_recalculate: "Recalculer",
      results_ranking_title: "Voir le classement détaillé",
      results_intl_title: "Équivalents Internationaux",
      results_intl_sub:
        "Découvrez quel parti ou mouvement correspond le plus à vos valeurs en France, Belgique et au Québec.",
      results_intl_fr: "France",
      results_intl_be: "Belgique",
      results_intl_qc: "Québec",
      results_intl_no_match:
        "Pas d'équivalent direct dans ce pays (spécificité politique tunisienne)",
      ...
      share_modal_sub:
        "Générez un lien compact avec votre nom pour le partager",
      ...
      results_no_data_body:
        "Vous n'avez pas encore passé le test. Répondez au questionnaire pour découvrir votre positionnement.",
      ...
      hist_aljoumhouri:
        "Pour comprendre Al Joumhouri, il faut remonter au Parti Démocrate Progressiste (PDP). Fondé en 1983 par Ahmed Néjib Chebbi, le PDP a été le principal parti d'opposition légale sous le régime de Ben Ali. En 2012, dans le but d'unifier la famille politique centriste face au gouvernement de la Troïka, le PDP fusionne avec d'autres formations (dont Afek Tounes) pour créer Al Joumhouri. La fusion échoue rapidement : Afek Tounes et plusieurs cadres se retirent, laissant Al Joumhouri amoindri sur le plan électoral au cours de la décennie suivante.",
      hist_baath:
        "Le parti Baath représente la branche tunisienne officielle du mouvement politique panarabe historique du même nom, né au Moyen-Orient. Présent de façon clandestine en Tunisie à partir des années 1950, il a opéré en marge de la politique officielle avant d'être légalisé après 2011. Son idéologie repose sur le nationalisme arabe unificateur. Son poids sur la scène politique et électorale tunisienne contemporaine est resté très limité.",
      hist_25jul:
        "Le Mouvement du 25-Juillet est une formation apparue à la suite des décisions du président Kaïs Saïed du 25 juillet 2021 (gel du parlement, renvoi du chef du gouvernement). Ce regroupement est composé de partisans de ces décisions et de comités de soutien au Président. Leur ligne politique défend un changement radical du système de gouvernance mis en place par la Constitution de 2014 et s'oppose au système des partis politiques traditionnels.",
      hist_tnp:
        "Le Parti Nationaliste Tunisien (TNP) est une formation politique qui s'est fait connaître publiquement au début de l'année 2023. Son discours et ses activités politiques sont presque exclusivement focalisés sur le rejet de la présence des migrants originaires d'Afrique subsaharienne sur le territoire tunisien. Le parti prône une définition stricte de l'identité nationale tunisienne, rejetant les affiliations africaines au profit d'un nationalisme local exacerbé.",
      hist_upl:
        "L'Union Patriotique Libre (UPL) a été créée en 2011 par l'homme d'affaires Slim Riahi. Le parti s'est démarqué lors de ses débuts par l'utilisation de campagnes de communication à très gros budget. Lors des élections législatives de 2014, il a obtenu la troisième place, ce qui lui a permis de participer au gouvernement de coalition. Le parti a cependant disparu de la scène politique quelques années plus tard, parallèlement aux poursuites judiciaires ayant visé son fondateur.",
      hist_pl:
        "Le PLT est le micro-parti de Mounir Baatour. Le parti est principalement connu pour les positions polémiques de son chef, notamment son soutien à la normalisation avec Israël et son militantisme LGBT.",
      hist_watad:
        "Le Mouvement des Patriotes Démocrates (connu sous l'acronyme Watad) est un parti marxiste d'orientation panarabe. Avant 2011, il était très actif dans les milieux syndicaux et étudiants sous le régime de Ben Ali en tant qu'opposition non reconnue. Légalisé après la révolution, il devient une force influente de la gauche. L'histoire du parti a été marquée par l'assassinat en février 2013 de son secrétaire général, Chokri Belaïd, événement qui a déclenché une crise politique majeure en Tunisie.",
      hist_massar:
        "Issu de la fusion en 2012 du mouvement Ettajdid ( anciennement Parti Communiste Tunisien), du Parti du Travail Tunisien et de militants indépendants de gauche, Al Massar se positionne comme un parti social-démocrate, de gauche républicaine et laïque. Actif dans l'opposition à la Troïka au sein de l'Union pour la Tunisie, le parti a vu sa trajectoire compromise par la participation de son secrétaire général Samir Taïeb au gouvernement de Youssef Chahed (2016-2020), un choix qui a provoqué des démissions en cascade, fracturé sa base militante et conduit à sa marginalisation.",
      hist_tahya:
        "Créé au début de l'année 2019, Tahya Tounes est un parti personnel et un véhicule électoral bâti autour du chef du gouvernement de l'époque, Youssef Chahed. Né d'une lutte de factions au sein de Nidaa Tounes contre la faction du Président de la République, le parti s'est constitué depuis le pouvoir grâce au ralliement de députés et de cadres d'horizons divers (Coalition Nationale, Al Moubadara). Défendant un programme libéral sur le plan économique et une gestion technocratique de l'État, le parti a obtenu 14 sièges aux législatives de 2019 avant de disparaître du paysage politique après 2021.",
      hist_frontpopulaire:
        "Fondé en octobre 2012, le Front Populaire était une coalition hétéroclite rassemblant la gauche radicale (marxistes du Parti des Travailleurs, du Watad, trotskystes), des partis nationalistes arabes (nassériens du Courant Populaire, baathistes), ainsi que des courants sociaux-démocrates (Al Qotb) et écologistes. Fer de lance de l'opposition extra-parlementaire à la Troïka et aux islamistes, particulièrement après les assassinats de ses figures Chokri Belaïd et Mohamed Brahmi en 2013, le Front a obtenu 15 députés en 2014 avec un programme antilibéral et d'interventionnisme étatique. Il a fini par imploser en 2019 en raison de son incapacité à organiser l'opposition et de désaccords stratégiques insolubles entre ses composantes.",
    },
    ...
    en: {
      ...
      hero_description:
        "Discover your political orientations through a questionnaire adapted to the Tunisian context.",
      cta_start: "TAKE THE TEST",
      card_what_title: "WHAT IS TUNISIAN VALUES?",
      card_what_meta:
        "73 questions (+ 25 optional) • 7 political axes • ~10 minutes",
      card_what_body:
        'TunisianValues is a political quiz adapted to the Tunisian context. You will respond to 73 main statements (+ 25 optional contextual ones) according to your level of agreement, from "Strongly Agree" to "Strongly Disagree."',
      card_axes_title: "7 POLITICAL AXES",
      card_axes_meta: "A multidimensional analysis of your values",
      card_axes_body:
        "At the end, your answers will place you on 7 major axes reflecting the different political sensibilities in Tunisia: Pan-Arabism, International Cooperation, Economy, Religion, Society, Democracy and Governance.",
      section_axes_title: "THE 7 AXES ANALYZED",
      section_axes_sub:
        "Your position on the major issues of Tunisian politics",
      footer_copy: "© 2026 TunisianValues.",

      instructions_title: "INSTRUCTIONS",
      instructions_body:
        "You will be presented with a series of statements. For each one, choose the option that best corresponds to your opinion.",
      btn_start: "START",
      ...
      opt_context_mode:
        "Enable contextual background notes (political history & institutions)",

      quiz_intermission_title: "MAIN PART COMPLETED!",
      quiz_intermission_text:
        "You have answered all the basic questions. You can now view your results, or continue with a few optional contextual questions on specific topics (Palestine, environment, historical heritage...) to refine your profile.",
      ...
      results_uncertain_body:
        'You answered "Neutral" to the majority of questions (>50%). You are likely Independent.',
      ...
      results_refine_body:
        "Assign an importance to each axis to adjust the calculation.",
      btn_recalculate: "Recalculate",
      results_ranking_title: "View detailed rankings",
      results_intl_title: "International Equivalents",
      results_intl_sub:
        "Discover which party or movement matches your values in France, Belgium, and Quebec.",
      results_intl_fr: "France",
      results_intl_be: "Belgium",
      results_intl_qc: "Quebec",
      results_intl_no_match:
        "No direct equivalent in this country (specific to the Tunisian political landscape)",
      ...
      share_modal_sub:
        "Generate a compact link with your name to share with friends",
      ...
      results_no_data_body:
        "You haven't taken the test yet. Answer the questionnaire to discover your political profile.",
      ...
      hist_alkarama:
        "Founded in 2019 by Seifeddine Makhlouf, the Al Karama Coalition established itself around a radical Islamist line and a populist discourse positioned to the right of Ennahdha. The movement drew attention for its confrontational communication methods, aggressively targeting its opponents, the press, and trade union institutions. Several of its senior leaders have been the subject of legal proceedings.",
      hist_attayar:
        "Created in 2013 by Mohamed Abbou following his resignation from the Troika government, the Democratic Current is a social-democratic party. Its program has historically focused on fighting financial and administrative corruption, applying the law, and strengthening state institutions. The party experienced electoral growth in 2019 and participated in Elyes Fakhfakh's government in 2020, before opposing the presidential measures of 2021.",
      hist_ettakatol:
  ...
  const questionsEN = {
    ...
    pana_culture:
      "Artistic and cultural competitions at the Arab world level should be developed.",
    ...
    pana_conflict:
      "Tunisia should automatically support its Arab neighbors in conflicts with non-Arab countries.",
    ...
    pana_independent:
      "Tunisian policies should be designed independently of Arab world priorities.",
    pana_distinct_culture:
      "Tunisian culture is distinct and must be protected from external influences, including from the Arab world.",
    pana_diplo:
      "Tunisia's diplomatic decisions should not be influenced by Arab causes that do not directly concern it.",
    ...
    coop_west_partners:
      "Tunisia should strengthen its partnerships with Western powers such as France, Italy, or the United States.",
    coop_fdi:
      "Openness to foreign investment is essential for the country's development.",
    coop_peacekeeping:
      "Tunisia should engage in humanitarian and peacekeeping missions abroad.",
    coop_sovereignty:
      "Tunisia must remain in control of its own political choices, even at the cost of international isolation.",
    coop_bad_institutions:
    ...
    econ_state_control:
      "The Tunisian state must control strategic economic sectors such as energy, transport, and telecommunications.",
    econ_services:
      "Essential public services such as health and education must remain free and accessible to all, even if this requires raising taxes.",
    econ_no_private: "Private companies must be abolished.",
    econ_regulation:
      "Large private companies must be regulated to prevent abuses.",
    econ_redistribution:
      "Redistribution of wealth is essential to reduce inequalities.",
    econ_competition:
      "Free competition stimulates innovation and economic growth.",
    ...
    econ_privatization:
      "The privatization of some state-owned companies would be beneficial.",
    econ_inequality: "Inequalities are inevitable in a prosperous economy.",
    econ_subsidies:
      "The state should massively subsidize bread, fuel and electricity.",
    econ_phd_jobs:
      "The Tunisian state should exceptionally recruit unemployed PhD holders to resolve the employment crisis in higher education.",
    econ_corrupt_elite:
      "The Tunisian economic model could work, but it is held hostage by a corrupt elite that enriches itself while the people grow poorer.",
    ...
    reli_state_support:
      "The state must actively support religious institutions.",
    ...
    reli_freedom:
      "Freedom of religion must include the freedom not to believe.",
    reli_influence:
      "Religious discourse must not influence political decisions.",
    reli_constitution:
      "Any mention of Islam should be removed from the constitution.",
    reli_education:
      "Tunisia's education system should align more closely with the principles of Islam as a moral and identity foundation.",
    reli_identity_primacy:
      "My religious identity takes precedence over my national belonging — I am Muslim before I am Tunisian.",
    soci_tradition:
      "Traditional Tunisian values and customs must be preserved.",
    soci_reforms:
      "Tunisian society requires rapid and significant social reforms.",
    soci_family: "The traditional role of the family must be protected.",
    soci_western_model:
      "Tunisia should model itself on Western societies to structure its own.",
    soci_gender:
      "Full equality between men and women must be guaranteed by law.",
    ...
    soci_liberty:
      "Traditions that limit individual freedoms must be abolished.",
    soci_languages:
    ...
    demo_checks:
      "Checks and balances (judiciary, parliament, media) must be protected.",
    ...
    demo_press_limit:
      "In certain situations, it is acceptable to limit press freedom.",
    demo_opposition:
      "Political opponents threaten the stability of the country.",
    demo_authoritarian:
    ...
    decent_central_unity:
      "A strong central power is necessary to prevent regional divisions.",
    decent_central_econ:
      "Economic decisions must remain in the hands of the central government.",
    decent_resources:
      "Management of natural resources must remain under central government control.",
    decent_council_regions:
      "The creation of the National Council of Regions and Districts to represent territories and rationalize parliamentary power is a fundamentally positive initiative.",
    decent_uniform_laws:
      "The same laws must apply uniformly across the entire territory.",
    decent_post_rev:
      "Post-revolution decentralization is essential to improve governance and bring decisions closer to citizens.",
    spec_monarchy:
      "It would be preferable for Tunisia to restore a constitutional monarchy.",
    spec_ugtt:
      "The UGTT plays a positive role in Tunisian political and social life.",
    spec_25jul:
      "The measures taken by Kais Saied on July 25, 2021 were necessary and justified to save the country.",
    spec_ks: "Kais Saied is a good president.",
    spec_2011: "Tunisia should have avoided the revolutionary process of 2011.",
    spec_maghreb:
      "Tunisia's future lies in a united Maghreb, built on our historical and cultural ties.",
    spec_africa:
      "Tunisia is part of Africa and must play a leading role in building a strong and sovereign African union.",
    ctx_normalisation:
      "The Tunisian parliament must adopt a law criminalizing any form of normalization with the Zionist entity.",
    spec_bourguiba:
      "The political legacy of Habib Bourguiba is overall positive.",
    ctx_gabes:
      "The state must immediately close or relocate the Chemical Group in Gabès for ecological reasons, even if it costs thousands of jobs.",
    ctx_imf:
      "Tunisia must refuse the dictates of the International Monetary Fund in order to preserve its sovereignty.",
    ctx_mig:
      "The state should require young doctors and engineers trained in the public system to work a few years in Tunisia before being allowed to emigrate.",
    ctx_mor:
      "Tunisia should lift the moratorium on the death penalty and restore its application for the most serious crimes.",
    ctx_civ:
      "Foreign-funded Tunisian associations and NGOs should be strictly regulated, or even banned, as they serve foreign agendas.",
    ctx_ben:
      "Zine el-Abidine Ben Ali is a president whose record is positive for Tunisia.",
    ctx_sub:
      "Irregular immigration from Sub-Saharan Africa constitutes a demographic and security threat to Tunisia.",
    ctx_corp:
      "State-promoted community enterprises are the best solution for developing marginalized regions and generating genuine local wealth creation.",
    ctx_dl54:
      "The enforcement of Decree 54 is an absolute necessity to cleanse social media of misinformation and defamation.",
    ctx_gafsa:
      "The state has the right to use the army to prohibit sit-ins and strikes that block the production and transport of phosphate in the Gafsa mining basin.",
    ctx_amb:
      "Tunisia should systematically expel any foreign ambassador who meets political opponents or members of civil society without prior approval from the Ministry of Foreign Affairs.",
    ctx_infl:
      "The state is right to imprison content creators on TikTok and Instagram who violate “public decency” and moral standards.",
    ctx_nsf:
      "The self-proclaimed “National Salvation Front” is an unnatural alliance that only seeks to return the country to the dysfunctions that existed before July 25.",
    ctx_ugtt:
  ...
  function setLang(lang) {
    ...
    document.dispatchEvent(
      new CustomEvent("tv:langchange", { detail: { lang } }),
    );
  }
  ...
  function updateToggleButtons() {
    document.querySelectorAll(".tv-lang-toggle").forEach((btn) => {
      btn.setAttribute(
        "aria-label",
        _lang === "fr" ? "Switch to English" : "Passer en français",
      );
      document.querySelectorAll("[data-tv-lang]").forEach((b) => {
        b.classList.toggle(
          "tv-lang-active",
          b.getAttribute("data-tv-lang") === _lang,
        );
      });
    });
  }
